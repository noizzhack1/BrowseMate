...
function isResearchQuestion(prompt) {
  ...
  const questionPatterns = [
    ...
    /\b(summarize|summarise|summerize|summerise|describe|explain|tell me about|give me|show me)\b.*\b(file|content|info|information|details)\b/i, // Summarize/describe file content (with typo variants)
    /\b(read|find|look for|search for)\b.*\b(and|then)\b.*\b(summarize|summarise|summerize|summerise|describe|explain|tell me)\b/i, // Find and summarize (with typo variants)
    /\b(read|find|look for|search for)\b.*\b(file|document|page)\b.*\b(summarize|summarise|summerize|summerise|describe|explain)\b/i // Find file and summarize (more flexible pattern)
  ];
