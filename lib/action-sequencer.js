...
function isResearchQuestion(prompt) {
  ...
  const questionPatterns = [
    ...
    /\b(summarize|summarise|describe|explain|tell me about|give me|show me)\b.*\b(file|content|info|information|details)\b/i, // Summarize/describe file content
    /\b(read|find|look for|search for)\b.*\b(and|then)\b.*\b(summarize|summarise|describe|explain|tell me)\b/i // Find and summarize
  ];
