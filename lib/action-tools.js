...
export function getActionTools() {
  return [
    ...
    },
    {
      type: 'function',
      function: {
        name: 'clickYouTubeVideo',
        description: 'Click a YouTube video from search results or the homepage. This is the BEST action for clicking YouTube videos - it intelligently finds video links.',
        parameters: {
          type: 'object',
          properties: {
            position: {
              type: 'number',
              description: 'Position of the video to click (1 for first video, 2 for second, etc.). Defaults to 1.',
              default: 1
            }
          },
          required: []
    ...
    },
    {
      type: 'function',
      function: {
        name: 'clickGoogleResult',
        description: 'Click a Google search result by position. This is the BEST action for clicking Google search results - it intelligently finds result links.',
        parameters: {
          type: 'object',
          properties: {
            position: {
              type: 'number',
              description: 'Position of the search result to click (1 for first result, 2 for second, etc.). Defaults to 1.',
              default: 1
            }
          },
          required: []
